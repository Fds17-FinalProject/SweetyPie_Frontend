...
const Icons = () => {
  ...
  return (
    <div className="">
      <div className="mb-2.4rem flex">
        <BsHouseDoor style={{ width: '2.4rem', height: '2.4rem' }} />
        <div className="ml-6">
          <div className="mb-0.4rem font-bold text-1.6rem">
            {accommodationType}
          </div>
      ...
      <div className="mb-2.4rem flex">
        ...
        <div className="ml-6">
          <div className="mb-0.4rem font-bold text-1.6rem">청결 강화</div>
          <div className="text-1.4rem text-#717171">
      ...
      <div className="mb-2.4rem flex">
        ...
        <div className="ml-6">
          <div className="mb-0.4rem font-bold text-1.6rem">셀프 체크인</div>
          <div className="text-1.4rem text-#717171">
            키패드를 이용해 체크인하세요.
          </div>
        </div>
      ...
      <div className="mb-2.4rem flex">
        ...
        />
        <div className="ml-6">
          <div className="mb-0.4rem font-bold text-1.6rem">환불 정책</div>
          <div className="text-1.4rem text-#717171">
      ...
      <div className="mb-2.4rem flex">
        ...
        <div className="ml-6">
          <div className="mb-0.4rem font-bold text-1.6rem">숙소 이용규칙</div>
          <div className="text-1.4rem text-#717171">
