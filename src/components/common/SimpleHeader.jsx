...
const UserMenu = ({ hideModal, showAuthModal }) => {
  ...
  <>
      ...
      {authVisible.type === 'login' && (
        <Modal>
          <AuthModal hideModal={hideModal} authVisible={authVisible} changeModal={changeModal} onChange={onChange} loginSubmit={loginSubmit} state={state} checkedLogin={checkedLogin}/>
        </Modal>
      )}
