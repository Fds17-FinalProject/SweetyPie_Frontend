...
const UserMenu = ({ hideModal, showAuthModal }) => {
  ...
  <>
      ...
      <MainHeader scrollY={ scrollY } searchStartState={searchStartState}>
        ...
        <AccommodationSearchHeader setLocation={setLocation} setCalendar={setCalendar} setPersonnel={setPersonnel} scrollY={scrollY} setScroll={setScrollY} searchStartState={searchStartState} showSearchHeader={showSearchHeader} location={location} calendar={calendar} personnel={personnel}/>
